...
#    14) what do you understand by _init_() method in python?? 
   
#    Ans: _init_ is a special method in python classes
#         is a constructor method for a class 
#         _init_ is called when ever an object of the class is constructed
